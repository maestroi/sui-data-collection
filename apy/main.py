...
def fetch_exchange_rates():
    url = "https://api.sui-data.com/token-exchange-rate/0x58baf5de9454ce6e6d17ebcf7d31513d700d012f304b16ef02e4a5b187cd9c13/testnet"
...
def main():
    ...
    unique_epochs = sorted(set(rate["epoch"] for rate in data["rates"] if rate["epoch"] != 0), reverse=True)
    ...
    for stake_subsidy_start_epoch in unique_epochs:
        ...
        logging.info(f"Epoch: {stake_subsidy_start_epoch}, Average APY: {average_apy:.8f}%")
